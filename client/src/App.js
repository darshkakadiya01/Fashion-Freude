...
import CategoryProducts from "./features/admin/pages/CategoryProducts";
    ...
    return (
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/refund_returns" element={<Returns />} />
                ...
                <Route path="/top-saree-styles-trends" element={<TopSareeStylesTrends />} />

                <Route path="/womens-best-nail-paint" element={<WomensBestNailPaint />} />

                <Route path="/womens-best-hair-styles" element={<WomensBestHairStyles />} />

                <Route path="/womens-best-heels" element={<WomensBestHeels />} />

                <Route path="/womens-best-lipstick" element={<WomensBestLipstick />} />

                <Route path="/best-budget-friendly-wallet" element={<BestBudgetFriendlyWallet />} />

                <Route path="/best-eyeliners" element={<BestEyeliners />} />

                <Route path="/essential-features-wallet" element={<EssentialFeaturesWallet />} />
                ...
                <Route path="/wallet-vs-clutch" element={<WalletVsClutch />} />

                <Route path="/stylish-womens-wallets" element={<StylishWomensWallets />} />
                ...
                <Route path="/womens-shoe-styles-trends" element={<WomensShoeStylesTrends />} />

                <Route path="/best-track-pant" element={<BestTrackPant />} />

                <Route path="/best-t-shirt" element={<BestTShirt />} />

                <Route path="/best-pant" element={<BestPant />} />
            </Routes>
