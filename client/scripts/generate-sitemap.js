...
// This script runs as its own Node process, so Create React App has not loaded the
// .env files yet — read them here so `.env.production` is the single source of truth.
// Anything already exported in the shell wins, then .env.production, then .env.
